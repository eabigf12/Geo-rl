...
import teaImg from '@assets/generated_images/turkish_tea_on_bosphorus.png';
import catImg from '@assets/generated_images/cute_cat_in_istanbul_street.png';
import capadociaImg from '@assets/generated_images/cappadocia_hot_air_balloons.png';
...
const INITIAL_POSTS: Post[] = [
  ...
  },
  {
    ...
    imageUrl: teaImg,
    user: {
      username: 'keyif_kahvesi',
      avatarUrl: 'https://github.com/shadcn.png'
    },
    location: 'Boğaz, İstanbul',
    likes: 856,
    isLiked: false,
    description: 'Boğaz havasında ince belli çay gibisi yok. ☕️',
    ...
    aiResult: {
      ...
      confidence: 0.99,
      facts: [
        'Türkiye, dünyada kişi başına en çok çay tüketen ülkedir.',
        'Genellikle ince belli bardakta servis edilir.',
        'Rize bölgesinde yetiştirilir.'
      ],
      classes: [
        { name: 'Çay', percentage: 99 },
        { name: 'İçecek', percentage: 95 },
        { name: 'Cam Bardak', percentage: 90 }
      ]
    }
  },
  {
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <AppContext.Provider value={{ posts, savedPosts, addPost, toggleLike, toggleSave, isSaved }}>
      {children}
    </AppContext.Provider>
  );
};
